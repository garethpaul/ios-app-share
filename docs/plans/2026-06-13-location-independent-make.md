# Location-Independent ios-app-share Verification
...
- Run checker compilation, shell/podspec syntax, project metadata parsing, and diff checks.
...
- Derived the checkout root from the sole loaded Makefile, rejected ambiguous
  Makefile inputs, and invoked the checker through its absolute path.
...
- Checker compilation, shell and Podfile syntax, project metadata parsing,
  diff hygiene, intended-path review, secret scanning, and artifact inspection passed.
